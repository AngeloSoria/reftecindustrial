<section
    ...
    <div class="flex gap-2 flex-row items-center justify-center sm:justify-end md:justify-center">
        <x-bi-telephone-fill class="md:hidden" />
    ...
    <div class="flex gap-1 col-span-2 md:col-span-1 flex-col sm:flex-row md:flex-col items-center sm:items-end justify-between md:justify-center">
        <div class="flex gap-2 items-end justify-center">
            <x-entypo-mail class="w-4 h-4" />

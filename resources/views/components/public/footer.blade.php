            ...
            <div class="flex gap-4 flex-col align-center lg:flex-row">
                        ...
                        <div class="mt-2 flex flex-col justify-start">
                            <div class="flex items-center justify-start gap-2">
                                <div class="p-1 m-0 w-8 h-8 flex items-center justify-center">
                                    @svg("fluentui-location-12", "w-8 h-8 p-0 m-0 text-white")
                                </div>
                                <a href="https://maps.app.goo.gl/WGAbyKPD9McargPf6" class="hover:underline"
                            ...
                            <div class="flex items-center justify-start gap-2">
                                <div class="p-1 m-0 w-8 h-8 flex items-center justify-center">
                                    @svg("fluentui-call-12", "w-5 h-5 p-0 m-0 text-white")
                                </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex flex-col justify-start">
                            <div class="flex items-center justify-start gap-2">
                                ...
                                <a href="https://maps.app.goo.gl/adGUc1M63rg3dNxYA" class="hover:underline"
                                    target="_blank" rel="noopener noreferrer">
                ...
                <div class="flex flex-col align-center justify-start md:align-start flex-1 text-white">
                    ...
                    <div class="mt-2">
                        <div class="flex items-center justify-start gap-2">
                            <div class="p-1 m-0 w-8 h-8 flex items-center justify-center">
                                @svg('entypo-facebook', 'w-8 h-8 p-0 m-0 text-white')
                            </div>
                            <a href="https://www.facebook.com/ReftecIndustrialSupplyandServicesInc/"
                                class="hover:underline" target="_blank" rel="noopener noreferrer">
                                <p class="text-sm">ReftecIndustrialSupplyandServicesInc</p>
                            </a>
                        </div>
                        <div class="flex items-center justify-start gap-2">
                            <div class="p-1 m-0 w-8 h-8 flex items-center justify-center">
                                @svg("fluentui-mail-16", "w-8 h-8 p-0 m-0 text-white")
                            </div>
                            <a href="mailto:reftecindustrialsupply@gmail.com" class="hover:underline" target="_blank"
                        ...
                        <div class="flex items-center justify-start gap-2">
                            ...
                            <a href="mailto:reftec.indl@gmail.com" class="hover:underline" target="_blank"
                                rel="noopener noreferrer">
                ...
                <div class="flex flex-col align-center justify-start md:align-start flex-1 text-white">
                    ...
                    <div class="mt-2">
                        <ul class="flex flex-col gap-2">
                            ...
                            <li>
                                <a href="{{ route('aboutus') }}" class="hover:underline text-sm">About Us</a>
                            </li>
                            <li>
                                <a href="{{ route('login') }}" class="hover:underline text-sm">Admin Panel</a>
                            </li>
                        </ul>
                    </div>
                </div>
